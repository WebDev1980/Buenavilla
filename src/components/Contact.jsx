...
export default function Contact({
  ...
  return (
    <div className={styles.wrap}>
      <h2 id="titulo-contacto" className={styles.heading}>Contacto</h2>
      <div className={styles.grid}>

        <a className={styles.card} href={waHref} target="_blank" rel="noopener noreferrer" aria-label="Abrir WhatsApp">
        ...
        <a className={styles.card} href={mapsHref} target="_blank" rel="noopener noreferrer" aria-label="Abrir en Google Maps">
          <div className={styles.icon}>
            <svg viewBox="0 0 24 24" fill="white" width="24" height="24" aria-hidden="true">
